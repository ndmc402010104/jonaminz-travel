...
- localStorage key 為相容性保留；內部 state schema 已升級為 version 3。
- 已實作資料關係：Trip、Place、Day、Stop、Booking、Checklist；Memory 容器已保留。
...
- 產品有四個正式模式：旅行首頁、Journey Builder、Live Trip、Book Studio。
